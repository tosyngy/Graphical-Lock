...
<html>
    ...
    <head>
        ...
        <title>Graphical password Authentication System - Claim Salary</title>
    ...
    <body>
            ...
            <div class="container text-center">
                ...
                <nav id="fh5co-main-nav" role="navigation">
                    <ul>
                        ...
                        <li><a href="loan.php">Load Facility</a></li>
        ...
        <div class="login-card">
            <h1><b>Graphical password Authentication Portal</b> <br/> Salary Portal</h1><br>
            ...
            <form>
                ...
                <div style="font-weight: 900">Amount: </div>
     ...
     <!--        <input type="password" name="pass" placeholder="Password">-->
                <div style="padding-top: 30px">
                    <input type="submit" name="claim" class="login login-submit btn-primary" value="Claim">
                </div>
                ...
                <span class="alert-warning up-pass shownot">You have claimed your salary for this month already</span>
                <span class="alert-success login-success shownot">Successfully</span>
            </form>
